      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-6">
          <div className="card shadow-xl p-6 border border-solid w-[25rem]">
            <figure>
              <img src="/others/Latest1.png" alt="Ducati XDIAVEL S-73" className="w-full"/>
            </figure>
          ...
          <div className="card shadow-xl p-6 border border-solid w-[25rem]">
            <figure>
              <img src="/others/Latest2.png" alt="Motorcycles & Scooters" className="w-full"/>
            </figure>
            <div className="card-body">
          ...
          <div className="card shadow-xl p-6 border border-solid w-[25rem]">
            <figure>
              <img src="/others/Latest3.png" alt="2021 Honda CBR500R" className="w-full"/>
            </figure>
            <div className="card-body">
